...
const (
	...
	MsgUserUsernameExists            = "user.username_exists"
	MsgUserEmailExists               = "user.email_exists"
	MsgUserUsernameAndEmailExists    = "user.username_and_email_exists"
...
const (
	...
	MsgOAuthLegacyBindingNotConfirmed = "oauth.legacy_binding_not_confirmed"

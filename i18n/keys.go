...
// Profit Board related messages
const (
	MsgProfitBoardNoChannel                = "profit_board.no_channel"
	MsgProfitBoardNoTag                    = "profit_board.no_tag"
	MsgProfitBoardInvalidScopeType         = "profit_board.invalid_scope_type"
	MsgProfitBoardRuleMustSpecifyModel     = "profit_board.rule_must_specify_model"
	MsgProfitBoardRuleOnlyOneDefault       = "profit_board.rule_only_one_default"
	MsgProfitBoardRuleNonNegative          = "profit_board.rule_non_negative"
	MsgProfitBoardComboMissingId           = "profit_board.combo_missing_id"
	MsgProfitBoardComboDuplicate           = "profit_board.combo_duplicate"
	MsgProfitBoardInvalidSitePricingMode   = "profit_board.invalid_site_pricing_mode"
	MsgProfitBoardComboSiteNonNegative     = "profit_board.combo_site_non_negative"
	MsgProfitBoardComboUpstreamNonNegative = "profit_board.combo_upstream_non_negative"
	MsgProfitBoardNoBatch                  = "profit_board.no_batch"
	MsgProfitBoardBatchDuplicate           = "profit_board.batch_duplicate"
	MsgProfitBoardPriceNonNegative         = "profit_board.price_non_negative"
	MsgProfitBoardInvalidCostSource        = "profit_board.invalid_cost_source"
	MsgProfitBoardInvalidUpstreamMode      = "profit_board.invalid_upstream_mode"
	MsgProfitBoardWalletRequireAccount     = "profit_board.wallet_require_account"
	MsgProfitBoardInvalidSiteSource        = "profit_board.invalid_site_source"
	MsgProfitBoardEndBeforeStart           = "profit_board.end_before_start"
	MsgProfitBoardCustomGranularityMin     = "profit_board.custom_granularity_min"
	MsgProfitBoardCustomGranularityMax     = "profit_board.custom_granularity_max"
	MsgProfitBoardInvalidGranularity       = "profit_board.invalid_granularity"
	MsgProfitBoardChannelNotExist          = "profit_board.channel_not_exist"
	MsgProfitBoardTagNoChannel             = "profit_board.tag_no_channel"
	MsgProfitBoardChannelDuplicateBatch    = "profit_board.channel_duplicate_batch"
	MsgProfitBoardInvalidParams            = "profit_board.invalid_params"
	MsgProfitBoardInvalidUpstreamAccount   = "profit_board.invalid_upstream_account"
	MsgProfitBoardBatchFormatError         = "profit_board.batch_format_error"

	// Remote observer messages
	MsgProfitBoardRemoteMissingURL   = "profit_board.remote_missing_url"
	MsgProfitBoardRemoteMissingUID   = "profit_board.remote_missing_uid"
	MsgProfitBoardRemoteMissingToken = "profit_board.remote_missing_token"
	MsgProfitBoardRemoteTokenEmpty   = "profit_board.remote_token_empty"
	MsgProfitBoardRemoteNotNewAPI    = "profit_board.remote_not_newapi"
	MsgProfitBoardRemoteURLInvalid   = "profit_board.remote_url_invalid"
	MsgProfitBoardRemoteRequestFail  = "profit_board.remote_request_fail"

	// Upstream account messages
	MsgProfitBoardAccountTypeUnsupported = "profit_board.account_type_unsupported"
	MsgProfitBoardAccountNameEmpty       = "profit_board.account_name_empty"
	MsgProfitBoardAccountInvalid         = "profit_board.account_invalid"
	MsgProfitBoardAccountTokenEmpty      = "profit_board.account_token_empty"
)

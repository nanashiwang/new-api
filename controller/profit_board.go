...
var profitBoardErrorMap = map[error]string{
	...
	model.ErrProfitBoardRemoteMissingEmail:        "远端额度观测已启用，但缺少远端邮箱",
	model.ErrProfitBoardRemoteMissingPassword:     "远端额度观测已启用，但缺少远端密码",
	...
	model.ErrProfitBoardAccountTypeUnsupported:    "当前仅支持 new-api 和 sub2api 上游账户",
	...
	model.ErrProfitBoardAccountEmailEmpty:         "sub2api 邮箱不能为空",
	model.ErrProfitBoardAccountPasswordEmpty:      "sub2api 密码不能为空",

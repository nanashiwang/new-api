	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/sellable-token/products", controller.ListSellableTokenProducts)
				selfRoute.POST("/sellable-token/purchase", middleware.CriticalRateLimit(), controller.PurchaseSellableToken)
				selfRoute.GET("/sellable-token/issuances", controller.ListSellableTokenIssuances)
				selfRoute.GET("/sellable-token/issuances/:id", controller.GetSellableTokenIssuance)
				selfRoute.POST("/sellable-token/issuances/:id/confirm", middleware.CriticalRateLimit(), controller.ConfirmSellableTokenIssuance)
				selfRoute.POST("/sellable-token/issuances/:id/cancel", middleware.CriticalRateLimit(), controller.CancelSellableTokenIssuance)
				selfRoute.POST("/sellable-token/issuances/cancel-all", middleware.CriticalRateLimit(), controller.CancelAllPendingSellableTokenIssuances)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/:id/sellable-token/products/:productId/context", controller.AdminGetUserSellableTokenProductContext)
				adminRoute.POST("/:id/sellable-token/issue", controller.AdminIssueSellableToken)
				adminRoute.POST("/:id/sellable-token/tokens/manage", controller.AdminManageUserSellableToken)
				adminRoute.POST("/:id/sellable-token/tokens/manage/batch", controller.AdminManageUserSellableTokenBatch)
				adminRoute.POST("/:id/sellable-token/issuances/:issuanceId/cancel", controller.AdminCancelUserSellableTokenIssuance)
				adminRoute.POST("/:id/sellable-token/issuances/:issuanceId/confirm", controller.AdminConfirmUserSellableTokenIssuance)
				adminRoute.POST("/:id/sellable-token/issuances/cancel/batch", controller.AdminBatchCancelUserSellableTokenIssuances)
		...
		redemptionRoute.Use(middleware.AdminAuth())
		{
			...
			redemptionRoute.GET("/sellable-token-products", controller.AdminListSellableTokenProducts)
			redemptionRoute.GET("/search", controller.SearchRedemptions)
			redemptionRoute.GET("/:id", controller.GetRedemption)
			redemptionRoute.POST("/", controller.AddRedemption)
			redemptionRoute.POST("/sellable-token-products", controller.AdminCreateSellableTokenProduct)
			redemptionRoute.PUT("/sellable-token-products/:id", controller.AdminUpdateSellableTokenProduct)
			redemptionRoute.PUT("/sellable-token-products/:id/status", controller.AdminUpdateSellableTokenProductStatus)
			redemptionRoute.DELETE("/sellable-token-products/:id", controller.AdminDeleteSellableTokenProduct)
